...
//Decompiled by DJ v3.12.12.101 Copyright 2016 Atanas Neshkov  Date: 11/13/2017 9:39:25 AM
...
//         OutlookPatternextract

@SuppressWarnings("unused")
public class OutlookMapper
{
 public static class Map extends Mapper<Object, Object, Object, Object>
 {

     @SuppressWarnings("unchecked")
	public void setup(@SuppressWarnings("rawtypes") org.apache.hadoop.mapreduce.Mapper.Context context)
     {
         mos = new MultipleOutputs<Object, Object>(context);
         emailCategory = context.getConfiguration().get("EmailCategory");
     }

     public void map(Text key, Text value, @SuppressWarnings("rawtypes") org.apache.hadoop.mapreduce.Mapper.Context context)
     ...
     protected void cleanup(@SuppressWarnings("rawtypes") org.apache.hadoop.mapreduce.Mapper.Context context)
         throws IOException, InterruptedException
     {
         mos.close();
     }
